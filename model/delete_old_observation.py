'''
A script to delete old observations from the database.
By default old observations are those made more than 8 days ago.

Usage:
python -m model.delete_old_observation [date-time] [debug]
'''
